...
public class BeatBox{
  ...
  String[] instrumentNames = {"Bass Drum", "Closed Hit-Hat", "Open Hit-Hat",
  ...
  public void buildGUI(){
    ...
    serializeIt.addActionListener(new MySendListListener());
  ...
  public class MySendListListener implements ActionListener{
